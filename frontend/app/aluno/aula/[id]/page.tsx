            ...
            {classroom?.cronograma_oficial ? (
              classroom.cronograma_oficial.map((aulaMeta: any, idx: number) => {
                ...
                return (
                  <div 
                    key={idx}
                    onClick={() => aulaCompleta && setSelectedAula(aulaCompleta)}
        ...
        <main className="flex-1 bg-slate-50 overflow-y-auto p-8">
          {!selectedAula ? (
            ...
            <div className="max-w-4xl mx-auto pb-20">
              <h2 className="text-3xl font-bold text-blue-900 mb-8 border-b-2 border-slate-200 pb-4">
